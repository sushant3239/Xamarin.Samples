package md500f9e35eb0429f1adc9d2433f7507e0c;


public class BindableExpandableListAdapter
		...
		android.widget.ExpandableListAdapter
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Samples.Android.Adapter.BindableExpandableListAdapter, Xamarin.Samples.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", BindableExpandableListAdapter.class, __md_methods);
	}


	public BindableExpandableListAdapter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == BindableExpandableListAdapter.class)
			mono.android.TypeManager.Activate ("Xamarin.Samples.Android.Adapter.BindableExpandableListAdapter, Xamarin.Samples.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public BindableExpandableListAdapter (android.content.Context p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == BindableExpandableListAdapter.class)
			mono.android.TypeManager.Activate ("Xamarin.Samples.Android.Adapter.BindableExpandableListAdapter, Xamarin.Samples.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
